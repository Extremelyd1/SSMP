...
internal class ChatBox : IChatBox {
    ...
    private static void SetEnabledHeroActions(bool enabled) {
        ...
        heroActions.MenuExtra.enabled = enabled;
        heroActions.MenuSuper.enabled = enabled;
        ...
        heroActions.Taunt.Enabled = enabled;
        heroActions.PaneRight.Enabled = enabled;
        heroActions.PaneLeft.Enabled = enabled;
        heroActions.OpenInventory.Enabled = enabled;
        heroActions.OpenInventoryMap.Enabled = enabled;
        heroActions.OpenInventoryJournal.Enabled = enabled;
        heroActions.OpenInventoryTools.Enabled = enabled;
        heroActions.OpenInventoryQuests.Enabled = enabled;
        heroActions.SwipeInventoryMap.Enabled = enabled;
