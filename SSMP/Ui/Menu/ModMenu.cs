...
internal class ModMenu {
    ...
    /// <summary>
    /// Constructs the mod menu class for SSMP.
    /// </summary>
    /// <param name="modSettings">The mod settings for SSMP.</param>
    ...
    // /// <summary>
    // /// Create the mod menu for SSMP. This consists of client-side settings (such as HUD elements and keybinds) and
    // /// server settings.
    // /// </summary>
