...
internal static class PlayerTargetRegistry {
    ...
    /// <summary>
    /// Determines whether the given object or one of its parents is a tracked player root.
    /// </summary>
    /// <param name="gameObject">The object to inspect.</param>
    /// <returns>True if the object belongs to a tracked player; otherwise false.</returns>
    public static bool IsTrackedPlayerObject(GameObject? gameObject) {
        return GetTrackedPlayerRoot(gameObject) != null;
    }
