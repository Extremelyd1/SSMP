...
/// <summary>
/// Specialization of <see cref="NetworkUpdateManager{TOutgoing,TPacketId}"/> for server to client packet sending.
/// </summary>
internal class ServerUpdateManager : NetworkUpdateManager<ClientUpdatePacket, ClientUpdatePacketId> {
    /// <inheritdoc />
