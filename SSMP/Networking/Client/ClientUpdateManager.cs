...
/// <summary>
/// Specialization of <see cref="NetworkUpdateManager{TOutgoing,TPacketId}"/> for client to server packet sending.
/// </summary>
internal class ClientUpdateManager : NetworkUpdateManager<ServerUpdatePacket, ServerUpdatePacketId> {
    /// <inheritdoc />
