...
internal class ClientAddonManager {
    ...
    /// <summary>
    /// Static constructor that initializes the list for addons registered outside of SSMP.
    /// </summary>
    ...
    public void LoadAddons() {
        ...
        // Now we add the addons that were registered by assemblies outside of SSMP
    ...
    /// <summary>
    /// Register an addon class from outside of SSMP.
    /// </summary>
